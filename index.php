...
$iaMailbox = $iaCore->factoryPlugin(IA_CURRENT_MODULE, iaCore::FRONT, 'mailbox');
...
if (iaView::REQUEST_HTML == $iaView->getRequestType()) {
    ...
    switch ($action) {
        ...
        */
        ...
        case 'move_to':
            ...
            $iaMailbox->moveMessagesToFolder($_POST['messages'], (int)$_POST['action_param'],
                iaUsers::getIdentity()->id);
    ...
    if ($mid) {
        ...
        $messages = $iaMailbox->getMessages(iaUsers::getIdentity()->id, $folderId, $pagination['start'],
            $pagination['limit']);
